...
import homebg1 from "../../../assets/images/homepage/Maskgroup.png";
 ...
 <section className="Home_Top_Banner bg-[#dcecfa]">
      ...
      {/* <section className="Home_Top_Banner bg-[#dcecfa] ">
        <div className="  flex  flex-col lg:flex-row items-center ">
          <div className=" md:ml-20 lg:ml-52">
          ...
          <div className="relative w-full  flex  justify-end">
            <img src={imageCircle} className="absolute  top-[10]" alt="" />
      ...
      <section className="h-full w-screen place-items-center bg-[#ffffff]   relative px-8 py-8 lg:mb-36 ">
        <div className="container mx-auto grid items-center lg:grid-cols-2">
          <div className="text-center lg:text-left pt-10">
            ...
            <p className="block antialiased font-sans text-xl font-normal leading-relaxed text-blue-gray-900 lg:pr-32">
            Skilled and Emotionally Intelligent Educators that will make learning exciting and engaging.
            </p>
            <div className="mt-2 ">
              <form className="max-w-xl mt-10 p-2 md:p-0 lg:p-0">
      ...
      {/* <section className="ContactUs_Top_Banner bg-[#2C6777]">
        <div className="container  py-10 lg:py-14 md:py-10 md:p-2  mx-auto ">
          <div className=" mx-autoz flex flex-wrap  md:flex-row flex-col items-center">
