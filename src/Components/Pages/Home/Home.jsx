    ...
    <>
                  ...
                  <form className="max-w-xl">
                    ...
                    <div className="relative">
                      ...
                      <input
                        type="search"
                        id="default-search"
                        className="block w-full p-3 pl-10 text-sm text-gray-900 border border-gray-300 rounded-full bg-white focus:ring-blue-500 focus:border-blue-500 dark:bg-white-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        placeholder="Search Mockups, Logos..."
                        required
                      />
                      <button
                        type="submit"
                        className="text-white absolute right-2.5 bottom-1 bg-[#2c6777]  focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-full text-sm px-4 py-2 dark:bg-[#2c6777] dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                      >
                        Search
                      </button>
                    </div>
      ...
      <section className="div3-Section w-full  bg-[#dcecfa]">
        <div className=" mt-16 mb-16 container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 items-center gap-2 p-2 ">
