                  ...
                  <div className="">
                    <div className="form_Contant bg-white rounded-xl p-4">
                      ...
                      <div>
                        <button
                          type="submit"
                          className="text-white bg-[#2c6777] hover:bg-[#2c6777] focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                        >
                          Submit
                        </button>
                      </div>
                  ...
                  <div className=" w-auto  bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <div className="p-4 ">
                      <p className="text-sm font-normal text-black dark:text-gray-400">
                        Contact us via email or give us a call to enquire about
                        our tutoring services, we’ll do our best to meet your
                        needs.
                      </p>
                      <ul className="my-4 space-y-3">
                        <li>
                          ...
                          >
                            ...
                            <span className="flex-1 ml-3 whitespace-wrap">
                              +111 222 333 444
                            </span>
                          </a>
                        </li>
                        <li>
                          ...
                          >
                            ...
                            <span className="flex-1 ml-3 whitespace-wrap">
                              Suite no - 25, 4th Floor, Bhuiyan Mansion, 6
