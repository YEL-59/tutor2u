...
const FindTutors = ({findTutorProps}) => {
  const {id,name,rating, random_id,balance,about}=findTutorProps
  return (
    <>
      <div key={ id} className="w-full  p-4 mt-5 text-center bg-white border border-gray-200 rounded-lg shadow sm:p-8">
              ...
              <div className="flex space-x-2 justify-center items-center">
                ...
                <div className="flex flex-col ">
                  ...
                  <div className="flex flex-wrap space-x-1">
                    ...
                    <p className="ml-2  text-sm font-medium text-gray-900 ">4{rating}</p>
                    <BiIdCard className="h-5" />
                    <a href="#" className="text-sm font-medium truncate text-gray-900 underline hover:no-underline ">#{ random_id}</a>
                  </div>
                </div>
        ...
        <div className="mt-2">
          ...
          <p className="mb-2 text-start text-gray-500 text-sm line-clamp-3">{about}</p>
        </div>
